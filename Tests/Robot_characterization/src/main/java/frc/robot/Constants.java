...
public final class Constants {
  ...
  public final static class DriveConstants {
    public static final double kAbsoluteEncoderOffsetFL = 0;//-2.292;//-2.224; //-0.358 + 1.892;
    public static final double kAbsoluteEncoderOffsetFR = 0;//0.586;//0.716; //-0.323 + 2.004;
    public static final double kAbsoluteEncoderOffsetBL = 0;//0.337;//1.003; //0.345 - 0.835;
    public static final double kAbsoluteEncoderOffsetBR = 0;//2.787;//3.031; //-0.435 - 3.574;
  }
