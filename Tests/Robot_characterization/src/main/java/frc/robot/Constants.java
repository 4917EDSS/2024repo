...
public final class Constants {
  ...
  public final static class DriveConstants {
    public static final double kAbsoluteEncoderOffsetFL = 0.888;//-2.292;//-2.224; //-0.358 + 1.892;
    public static final double kAbsoluteEncoderOffsetFR = 2.730;//0.586;//0.716; //-0.323 + 2.004;
    public static final double kAbsoluteEncoderOffsetBL = 2.170;//0.337;//1.003; //0.345 - 0.835;
    public static final double kAbsoluteEncoderOffsetBR = -0.628;//2.787;//3.031; //-0.435 - 3.574;
  }
