...
import frc.robot.commands.RotationalVelocityCharacterization;
import frc.robot.commands.VelocityCharacterization;
/*
...
public class RobotContainer {
  ...
  private void configureBindings() {
    m_driverController.cross().onTrue(new VelocityCharacterization(m_drivetrainSub));
    m_driverController.square().onTrue(new RotationalVelocityCharacterization(m_drivetrainSub));
