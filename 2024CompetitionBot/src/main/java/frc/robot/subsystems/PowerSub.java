...
public class PowerSub extends SubsystemBase {
  ...
  public PowerSub() {
    ...
    m_sbDriveMotorFrontRight =
        m_shuffleboardTab.add("DFR" + Constants.Breakers.kDriveMotorFrontRight, 0).withPosition(0, 0).getEntry();
    ...
    m_sbIntakeRollers =
        m_shuffleboardTab.add("Intake Rollers" + Constants.Breakers.kIntakeRollers, 0).withPosition(3, 3).getEntry();
  ...
  private void updateShuffleBoard() {
    ...
    m_sbDriveMotorFrontRight.setDouble(powerDistributionModule.getCurrent(Constants.Breakers.kDriveMotorFrontRight));
