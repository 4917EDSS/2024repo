...
public class ShootSpeakerSubwooferGrp extends SequentialCommandGroup {
  /** Creates a new ShootSpeakerSubwooferGrp. */
  public ShootSpeakerSubwooferGrp(ShooterSub shooterSub) {
