...
/**
 * This is an utility class used for parsing the json from Limelight.
 * Please refer to api at: https://docs.limelightvision.io/docs/docs-limelight/apis/json-dump-specification
 * 
 * The code was sourced from the Github, reflected on the doc:
